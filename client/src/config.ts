...
export class Config implements ClientConfig {
  ...
  constructor(data: Partial<ClientConfig> = {}) {
    ...
    this.reconnectInterval = data.reconnectInterval ?? DEFAULT_CONFIG.RECONNECT_INTERVAL;
    this.maxReconnectAttempts = data.maxReconnectAttempts ?? DEFAULT_CONFIG.MAX_RECONNECT_ATTEMPTS;

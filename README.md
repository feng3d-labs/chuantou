...
启动成功后，访问 `http://server.com:8080` 即可访问本地的 3000 端口服务。
...
# WebSocket 代理
npx @feng3d/chuantou-client -s ws://server.com:9000 -t mytoken -p "8081:ws:3001:localhost"

# 多个代理
npx @feng3d/chuantou-client -s ws://server.com:9000 -t mytoken -p "8080:http:3000:localhost,8081:ws:3001:localhost"
```
